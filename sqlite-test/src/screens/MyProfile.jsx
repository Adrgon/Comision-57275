...
import { useDB } from '../hooks/useDB'; // import el hook

const MyProfile = ({navigation}) => {

      const dispatch = useDispatch()
      const { truncateSessionTable } = useDB() // perparo el metodo
      ...
      const signOut =  () => {
        try {         
          const response =  truncateSessionTable(); // Liquidamos la session 
